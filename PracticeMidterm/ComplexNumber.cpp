...
//         inline char getOp() const {return op; };
//         inline int getB() const {return b; };
//         friend std::ostream& operator <<(std::ostream& outStream, const ComplexNumber& num);
//         friend const ComplexNumber operator +(const ComplexNumber& complex1, const ComplexNumber& complex2);
//     private:
//         int a, b;
//         char op;
// }; //* End ComplexNumber
...
//     int x, y;
//     char ops;
//     x = (complex1.a + complex2.a);
//     if(complex1.op == '+' && complex2.op == '+') {
//         y = complex1.b + complex2.b;
//         ops = '+';
//     }
//     else if(complex1.op == '-' && complex2.op == '+'){
//         y = -(complex1.b) + complex2.b;
//         if(y<0) {
//             ops = '-';
//             y = abs(y);
